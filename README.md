...
Tools:MIRO, CANVA GRANTT CHARTS

Data Processing: Contains the core SQL scripts used for data cleaning, joining user profiles with viewership metrics, and categorical logic.
Tools: Databricks
