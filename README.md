...
Project Description & Raw Data/: Documentation of the case study parameters and the foundational datasets.

Project Planning/: Strategic roadmap and methodology used for the analysis.

Data Processing/: Contains the core SQL scripts (Brightttvcode.sql) used for data cleaning, joining user profiles with viewership metrics, and categorical logic.

Project Presentation/: (Placeholder) Visual assets and summaries designed for executive-level delivery.
...
Strategic Growth: Data suggests prioritizing engagement during peak usage windows to drive subscription and ad revenue.
